// Copyright (c) 2026 David Haz. Based on React Bits' GradualBlur component.
// Distributed under the MIT + Commons Clause License Condition v1.0; see GradualBlur.LICENSE.md.
'use client'
